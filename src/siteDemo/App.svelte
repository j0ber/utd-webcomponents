    ...
    <header role="banner">
        ...
        <div id="javascriptDesactive" class="fureteur-desuet">
            <div class="utd-container" role="alert" aria-atomic="true">
                <div class="icone">
                    <img alt="Icône avertissement" src="/images/utd-sprite-v1.4.0.svg#ico-avertissement" width="28" height="26" aria-hidden="true">
                </div>
                <div class="texte">
            ...
            <div class="utd-container">
                <div class="conteneur-sections">
                    <div class="section-gauche signature-gouvernement" lang="fr">
                        <a href="/">
                            <img alt="Signature du gouvernement du Québec. Accédez à Système de design MTESS." src="/images/utd-sprite-v1.4.0.svg#QUEBEC_blanc">
                        </a>
                    </div>
