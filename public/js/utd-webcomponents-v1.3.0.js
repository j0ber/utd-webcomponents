(function () {
  ...
  function create_if_block$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$3, 59, 8, 1642);
        add_location(div, file$3, 55, 6, 1526);
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$3(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$3, 47, 8, 1306);
        attr_dev(span0, "class", "titre");
        add_location(span0, file$3, 43, 6, 1221);
        attr_dev(span1, "class", span1_class_value = "utd-icone-svg " + (
        /*afficher*/
        ctx[0] ? 'moins' : 'plus') + " md");
        add_location(span1, file$3, 49, 6, 1356);
        ...
        /*afficher*/
        ctx[0]);
        add_location(button, file$3, 42, 4, 1107);
        attr_dev(div0, "class", "entete");
        add_location(div0, file$3, 41, 2, 1081);
        attr_dev(div1, "id",
        /*idContenu*/
        ctx[3]);
        attr_dev(div1, "class", "contenu");
        add_location(div1, file$3, 53, 4, 1457);
        ...
        add_location(link, file$3, 66, 0, 1718);
      },
  ...
  function create_fragment$2(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        /*type*/
        ctx[1]);
        add_location(div0, file$2, 18, 4, 451);
        attr_dev(div1, "class", "zone-icone");
        add_location(div1, file$2, 17, 2, 421);
        attr_dev(h2, "class", "titre d-flex justify-content-between align-self-center");
        add_location(h2, file$2, 21, 4, 561);
        attr_dev(slot, "name", "contenu");
        add_location(slot, file$2, 28, 6, 746);
        attr_dev(div2, "class", "texte");
        add_location(div2, file$2, 24, 4, 660);
        attr_dev(div3, "class", "contenu zone-html");
        add_location(div3, file$2, 20, 2, 524);
        ...
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents-v1.3.0.min.css");
        add_location(link, file$2, 33, 0, 803);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  var file$1 = "src\\librairie\\components\\dialogueModal.svelte"; // (120:0) {#if estModaleAffichee}
  ...
  function create_if_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div0, file$1, 120, 2, 3946);
        attr_dev(span, "aria-hidden", "true");
        attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
        add_location(span, file$1, 144, 8, 4691);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "close");
        attr_dev(button, "aria-label",
        /*srTexteBoutonFermer*/
        ctx[8]);
        add_location(button, file$1, 138, 8, 4521);
        attr_dev(h1, "id",
        /*idEntete*/
        ctx[6]);
        ...
        add_location(div4, file$1, 137, 4, 4488);
        ...
        /*idCorps*/
        ctx[7] : null);
        attr_dev(div5, "class", "utd-component utd-dialog");
        attr_dev(div5, "id",
        /*idModale*/
        ctx[5]);
        attr_dev(div5, "aria-modal", "true");
        attr_dev(div5, "role", "dialog");
        add_location(div5, file$1, 121, 2, 4026);
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          ...
          /*click_handler*/
          ctx[19], false, false, false), listen_dev(button, "click",
          /*click_handler_1*/
          ctx[20], false, false, false), listen_dev(div5, "click",
          /*clickModale*/
          ctx[11], false, false, false), listen_dev(div5, "keydown",
          /*keydown*/
          ctx[10], false, false, false), listen_dev(div5, "introend",
          /*ajusterModalePendantAffichage*/
          ctx[13], false, false, false), listen_dev(div5, "outroend",
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(120:0) {#if estModaleAffichee}",
      ctx: ctx
    });
    return block;
  } // (152:10) {#if type}
  ...
  function create_if_block_2$1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(152:10) {#if type}",
      ctx: ctx
    });
    return block;
  } // (162:8) {#if Utils.slotExiste(slots, 'pied')}
  ...
  function create_if_block_1$1(ctx) {
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(162:8) {#if Utils.slotExiste(slots, 'pied')}",
      ctx: ctx
    });
    return block;
  }
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    onMount(function () {
      ...
      $$invalidate(4, slots = Array.from(thisComponent.querySelectorAll('[slot]')));
      mounted = true;
    });

    function masquerModale(raisonFermetureModale) {
      $$invalidate(3, estModaleAffichee = false);
      $$invalidate(14, afficher = 'false'); //Si une raison de fermeture est reçue en param, on l'utilise sinon on prend la raison de fermeture qui est sur la modale "raisonfermeture" qui va contenir une raison de fermeture externe à la modale (ex. clic sur bouton primaire ou secondaire)
    ...
    function toggleAfficher() {
      if (mounted) {
        if (afficher === 'true') {
          $$invalidate(15, raisonfermeture = '');
          Utils.ajusterInterfaceAvantAffichageModale(html, body);
          $$invalidate(3, estModaleAffichee = true);
        } else {
    ...
    var writable_props = ['afficher', 'type', 'estfenetremessage', 'raisonfermeture', 'titre', 'lang', 'srboutonfermer', 'idfocus'];
    Object.keys($$props).forEach(function (key) {
    ...
    $$self.$$set = function ($$props) {
      if ('afficher' in $$props) $$invalidate(14, afficher = $$props.afficher);
      if ('type' in $$props) $$invalidate(0, type = $$props.type);
      if ('estfenetremessage' in $$props) $$invalidate(1, estfenetremessage = $$props.estfenetremessage);
      if ('raisonfermeture' in $$props) $$invalidate(15, raisonfermeture = $$props.raisonfermeture);
      ...
      if ('idfocus' in $$props) $$invalidate(18, idfocus = $$props.idfocus);
    };
    ...
    $$self.$inject_state = function ($$props) {
      ...
      if ('srboutonfermer' in $$props) $$invalidate(17, srboutonfermer = $$props.srboutonfermer);
      if ('idfocus' in $$props) $$invalidate(18, idfocus = $$props.idfocus);
      if ('estModaleAffichee' in $$props) $$invalidate(3, estModaleAffichee = $$props.estModaleAffichee);
      if ('html' in $$props) html = $$props.html;
      if ('body' in $$props) body = $$props.body;
      if ('slots' in $$props) $$invalidate(4, slots = $$props.slots);
    ...
    return [type, estfenetremessage, titre, estModaleAffichee, slots, idModale, idEntete, idCorps, srTexteBoutonFermer, masquerModale, keydown, clickModale, finAnimationFermeture, ajusterModalePendantAffichage, afficher, raisonfermeture, lang, srboutonfermer, idfocus, click_handler, click_handler_1];
  }
  ...
  var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
    ...
    _createClass(DialogueModal, [{
      ...
      key: "observedAttributes",
      get: function get() {
        return ["afficher", "type", "estfenetremessage", "raisonfermeture", "titre", "lang", "srboutonfermer", "idfocus"];
      }
    }]);
