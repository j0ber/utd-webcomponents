(function () {
  ...
  var file$1 = "src\\librairie\\components\\dialogueModal.svelte"; // (109:0) {#if estModaleAffichee}
  ...
  function create_if_block$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div0, file$1, 109, 2, 3632);
        attr_dev(span, "aria-hidden", "true");
        attr_dev(span, "class", "utd-icone-svg x-fermer-bleu");
        add_location(span, file$1, 132, 8, 4293);
        attr_dev(button, "type", "button");
        attr_dev(button, "class", "close");
        attr_dev(button, "aria-label",
        /*srTexteBoutonFermer*/
        ctx[5]);
        add_location(button, file$1, 126, 8, 4123);
        attr_dev(h1, "id",
        /*idEntete*/
        ctx[4]);
        attr_dev(h1, "class", "titre-dialog");
        attr_dev(h1, "tabindex", "-1");
        add_location(h1, file$1, 139, 10, 4477);
        attr_dev(div1, "class", "entete");
        add_location(div1, file$1, 138, 8, 4445);
        attr_dev(slot, "name", "contenu");
        add_location(slot, file$1, 144, 10, 4625);
        attr_dev(div2, "class", "corps");
        add_location(div2, file$1, 143, 8, 4594);
        attr_dev(div3, "class", "principal");
        add_location(div3, file$1, 137, 6, 4412);
        attr_dev(div4, "class", "conteneur");
        add_location(div4, file$1, 125, 4, 4090);
        ...
        add_location(div5, file$1, 110, 2, 3712);
      },
      m: function mount(target, anchor) {
        ...
        if (!mounted) {
          ...
          /*click_handler*/
          ctx[16], false, false, false), listen_dev(button, "click",
          /*click_handler_1*/
          ctx[17], false, false, false), listen_dev(div5, "click",
          /*clickModale*/
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(109:0) {#if estModaleAffichee}",
      ctx: ctx
    });
    return block;
  } // (147:8) {#if Utils.slotExiste(slots, 'pied')}
  ...
  function create_if_block_1$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file$1, 148, 12, 4755);
        attr_dev(div, "class", "pied");
        add_location(div, file$1, 147, 10, 4723);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        append_dev(div, slot);
    ...
    dispatch_dev("SvelteRegisterBlock", {
      ...
      type: "if",
      source: "(147:8) {#if Utils.slotExiste(slots, 'pied')}",
      ctx: ctx
    });
    return block;
  }
  ...
  function create_fragment$1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        attr_dev(link, "rel", "stylesheet");
        attr_dev(link, "href", "/css/utd-webcomponents-v1.3.0.min.css");
        add_location(link, file$1, 156, 0, 4865);
      },
      l: function claim(nodes) {
        throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
      },
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    function masquerModale(raisonFermetureModale) {
      ...
      $$invalidate(11, afficher = 'false'); //Si une raison de fermeture est reçue en param, on l'utilise sinon on prend la raison de fermeture qui est sur la modale "raisonfermeture" qui va contenir une raison de fermeture externe à la modale (ex. clic sur bouton primaire ou secondaire)
    ...
    var writable_props = ['afficher', 'raisonfermeture', 'titre', 'lang', 'srboutonfermer', 'idfocus'];
    Object.keys($$props).forEach(function (key) {
    ...
    $$self.$$set = function ($$props) {
      ...
      if ('raisonfermeture' in $$props) $$invalidate(12, raisonfermeture = $$props.raisonfermeture);
      if ('titre' in $$props) $$invalidate(0, titre = $$props.titre);
      if ('lang' in $$props) $$invalidate(13, lang = $$props.lang);
      if ('srboutonfermer' in $$props) $$invalidate(14, srboutonfermer = $$props.srboutonfermer);
      if ('idfocus' in $$props) $$invalidate(15, idfocus = $$props.idfocus);
    };
    ...
    return [titre, estModaleAffichee, slots, idModale, idEntete, srTexteBoutonFermer, masquerModale, keydown, clickModale, finAnimationFermeture, ajusterModalePendantAffichage, afficher, raisonfermeture, lang, srboutonfermer, idfocus, click_handler, click_handler_1];
  }
  ...
  var DialogueModal = /*#__PURE__*/function (_SvelteElement) {
    ...
    _createClass(DialogueModal, [{
      ...
      key: "observedAttributes",
      get: function get() {
        return ["afficher", "raisonfermeture", "titre", "lang", "srboutonfermer", "idfocus"];
      }
    }]);
  ...
  function create_if_block_4(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file, 101, 54, 3402);
        attr_dev(span, "class", "texte-lie");
        add_location(span, file, 101, 4, 3352);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(div, file, 116, 4, 3867);
        attr_dev(span0, "class", "sr-only");
        add_location(span0, file, 132, 10, 4387);
        add_location(span1, file, 133, 10, 4448);
        attr_dev(h1, "id",
        /*idEntete*/
        ctx[6]);
        attr_dev(h1, "tabindex", "-1");
        ...
        add_location(span6, file, 117, 4, 3926);
      },
      m: function mount(target, anchor) {
        insert_dev(target, div, anchor);
        insert_dev(target, t0, anchor);
  ...
  function create_if_block_1(ctx) {
    ...
    var block = {
      c: function create() {
        ...
        add_location(slot, file, 154, 12, 5007);
        add_location(span, file, 155, 12, 5062);
      },
      m: function mount(target, anchor) {
